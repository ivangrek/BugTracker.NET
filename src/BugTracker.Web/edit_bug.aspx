...
<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="edit_bug.aspx.cs" Inherits="BugTracker.Web.edit_bug" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
                                                                    ...
                                                                    <tr id="row7">
                                                                        <td nowrap>
                                                                            <span class="lbl" id="udf_label" runat="server">
                                                                                <% Response.Write(Util.get_setting("UserDefinedBugAttributeName", "YOUR ATTRIBUTE")); %>:&nbsp;
                                                                            </span>
                                                                            <td nowrap>
                                                ...
                                                <%
                                                    if (permission_level != Security.PERMISSION_READONLY)
                                                    {
                                                        Response.Write("Entering \""
                                                                       + Util.get_setting("BugLinkMarker", "bugid#")
