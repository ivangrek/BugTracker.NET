...
<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="send_email.aspx.cs" Inherits="BugTracker.Web.send_email" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
                ...
                <td>
                    ...
                    <form class="frm" runat="server" enctype="multipart/form-data">
                        <table border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <input runat="server" type="checkbox" class="txt" id="include_bug">Include print of <% Response.Write(Util.get_setting("SingularBugLabel", "Bug")); %></td>
                            </tr>
    ...
    <div id="addrs" class="frm" style="display: none; position: absolute;">
        ...
        <select id="addrs_select" size="20" onchange="select_addrs(this)" style="margin-bottom: 5px;">
            <%
                ...
                var dict_users_for_this_project = new Dictionary<int, int>();
                ...
                if (Session["email_addresses"] == null)
                {
					...
					order by us_email";
                        ...
                        var ds_users_for_this_project = DbUtil.get_dataset(this.sql);
                    ...
                    var dt_related_users = Util.get_related_users(this.security, true); // force full names
                                                                                        // let's sort by email
                    var dv_related_users = new DataView(dt_related_users);
                    ...
                    foreach (DataRowView drv_email in dv_related_users)
                        ...
                        {
                            var email = (string)drv_email["us_email"];
                            var username = (string)drv_email["us_username"];
