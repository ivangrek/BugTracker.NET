namespace BugTracker.Web.Controllers
{
    ...
    public class ReportController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.Title = $"{this.applicationSettings.ApplicationTitle} - Reports";
            ViewBag.SelectedItem = MainMenuSection.Reports;
        ...
        public ActionResult Show(int id, string view, int scale = 1)
        {
            ...
            var rpSql = dataRow.Sql
                ...
                .Replace("$ME", Convert.ToString(User.Identity.GetUserId()));

            var dataSet = this.dbUtil
                .GetDataSet(rpSql);
            ...
            {
                ViewBag.Title = dataRow.Name;
                ViewBag.SelectedItem = MainMenuSection.Reports;

                var model = dataSet.Tables[0];
        ...
        public ActionResult Select()
        {
            ...
            ViewBag.Title = $"{this.applicationSettings.ApplicationTitle} - Select report";
            ViewBag.SelectedItem = MainMenuSection.Reports;

            var model = this.reportService
                .LoadSelectList()
                .Tables[0];
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Title = $"{this.applicationSettings.ApplicationTitle} - New report";
            ViewBag.SelectedItem = MainMenuSection.Reports;
        ...
        public ActionResult Create(EditModel model)
        {
            ...
            var parameters = new Dictionary<string, string>
            {
                ...
                { "$de", model.Name },
                { "$sq", WebUtility.HtmlDecode(model.SqlText) },
        ...
        public ActionResult Update(int id)
        {
            ...
            ViewBag.Title = $"{this.applicationSettings.ApplicationTitle} - Edit report";
            ViewBag.SelectedItem = MainMenuSection.Reports;
        ...
        public ActionResult Delete(int id)
        {
            ...
            ViewBag.Title = $"{this.applicationSettings.ApplicationTitle} - Delete report";
            ViewBag.SelectedItem = MainMenuSection.Reports;
        ...
        public ActionResult Dashboard()
        {
            ...
            ViewBag.Title = $"{this.applicationSettings.ApplicationTitle} - Dashboard";
            ViewBag.SelectedItem = MainMenuSection.Reports;
            ...
            sql = sql.Replace("$us", Convert.ToString(User.Identity.GetUserId()));
        ...
        public ActionResult EditDashboard()
        {
            ...
            ViewBag.Title = $"{this.applicationSettings.ApplicationTitle} - Edit dashboard";
            ViewBag.SelectedItem = MainMenuSection.Reports;
            ...
            var sql = @"
                ...
                where ds_user = $user
                order by ds_col, ds_row"
                .Replace("$user", Convert.ToString(User.Identity.GetUserId()));
        ...
        public ActionResult UpdateDashboard(string action, int? dashboardId, int? reportId, int? column, string chartType)
        {
            ...
            else if (action == "moveup" || action == "movedown")
            {
                ...
                sql = sql.Replace("$user", Convert.ToString(User.Identity.GetUserId()));
            }
