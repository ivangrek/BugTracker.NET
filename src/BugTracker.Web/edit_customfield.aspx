...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_customfield.aspx.cs" Inherits="BugTracker.Web.edit_customfield" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
                    ...
                    <p>
                        <form class="frm" runat="server">
                            <table border="0">
                                ...
                                <span class="smallnote" style="font-size: 12pt; font-weight: bold;" id="name" runat="server"></span>
                                    </td>
                                </tr>
