...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SvnLog.aspx.cs" Inherits="BugTracker.Web.SvnLog" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    <form id="frm" target="_blank" action="SvnDiff.aspx" method="GET">
