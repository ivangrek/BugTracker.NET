...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_project.aspx.cs" Inherits="BugTracker.Web.edit_project" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
            ...
            <tr>
                <td>
                    ...
                    <br>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <span class="smallnote">The following is used as the "From" email address when you respond to <% Response.Write(Util.get_setting("PluralBugLabel", "bug")); %> generated by emails
                                        </span>
                                    </td>
                                </tr>
