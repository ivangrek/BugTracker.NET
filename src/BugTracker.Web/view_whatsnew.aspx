...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_whatsnew.aspx.cs" Inherits="BugTracker.Web.view_whatsnew" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
        ...
        function process_json(json) {
            ...
            for (i = my_news_list.length - 1; i > -1; i--) {
                ...
                var tr = "<tr><td class=datad style='background:" +
                    ...
                    "<td class=datad>" +
                    news.bugid +
                    "<td class=datad><a href=edit_bug.aspx?id=" +
                    news.bugid +
                    ">" +
                    news.desc +
                    "</a>" +
            ...
            $.ajax(
                {
                    ...
                    success: function (data) {
                        ...
                        setTimeout(get_news,
                            1000 *
                        <% Response.Write(Util.get_setting("WhatsNewPageIntervalInSeconds", "20"));%> );
                    },
...
<asp:Content ContentPlaceHolderID="BodyHeader" runat="server">
    <% this.security.write_menu(Response, "news"); %>
</asp:Content>
