            ...
            <tr>
                <td>
                    ...
                    <form class="frm" runat="server">
                        ...
                        <div id="tab1" style="display: block;">
                            <table border="0" cellpadding="3">
                                ...
                                <tr>
                                    <td class="lbl">Auto-Assign New <% Response.Write(Util.GetSetting("PluralBugLabel", "bug")); %> to Default User:</td>
                                    <td>
                    ...
                    <br>
                                ...
                                <tr>
                                    <td class="lbl">Enable Receiving <% Response.Write(Util.GetSetting("PluralBugLabel", "bug")); %> via POP3 (btnet_service.exe):</td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <span class="smallnote">The following is used as the "From" email address when you respond to <% Response.Write(Util.GetSetting("PluralBugLabel", "bug")); %> generated by emails
                                        </span>
                                    </td>
                                </tr>
