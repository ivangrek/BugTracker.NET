            ...
            <tr>
                <td>
                    <ul>
                        ...
                        <p />
                        <li class="listitem">
                            <a href="<%= ResolveUrl("~/Administration/Projects/List.aspx")%>">Projects</a>
                        </li>
                        <p />
                        <li class="listitem">
                            <a href="<%= ResolveUrl("~/Administration/Categories/List.aspx")%>">Categories</a>
                        </li>
                        <p />
                        <li class="listitem">
                        ...
                        <p />
                        <li class="listitem">
                            <a href="<%= ResolveUrl("~/Administration/Statuses/List.aspx")%>">Statuses</a>
                        </li>
                        <p />
                        <li class="listitem">
