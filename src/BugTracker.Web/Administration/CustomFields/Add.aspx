...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="BugTracker.Web.Administration.CustomFields.Add" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
                    ...
                    <form class="frm" runat="server">
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input runat="server" type="text" class="txt" id="length" maxlength="6" size="6" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input runat="server" type="text" class="txt" id="default_text" maxlength="30" size="30" />
                                </td>
