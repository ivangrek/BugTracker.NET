...
namespace BugTracker.Web
{
    ...
    public partial class GitLog : Page
    {
...
order by gitcom_commit desc, gitap_path";
            ...
            string msg)
        {
            ...
            Response.Write(
                "<td class=datad><a target=_blank href=GitView.aspx?revpathid=" + this.StringAffectedPathId
                                                                                 + "&commit=" + commit
                                                                                 + ">");
            ...
            Response.Write(
                "<td class=datad><a target=_blank href=GitBlame.aspx?revpathid=" + this.StringAffectedPathId
                                                                                  + "&commit=" + commit
                                                                                  + ">");
