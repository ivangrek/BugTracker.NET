...
namespace BugTracker.Web
{
    ...
    public partial class HgLog : Page
    {
...
order by hgrev_revision desc, hgap_path";
        ...
        public void fetch_and_write_history()
        {
            ...
            for (var i = revisions.Count - 1; i > -1; i--)
            {
                ...
                Response.Write(
                    "<td class=datad><a target=_blank href=HgView.aspx?revpathid=" + this.StringAffectedPathId
                                                                                    + "&rev=" + revision
                                                                                    + ">");
                ...
                Response.Write(
                    "<td class=datad><a target=_blank href=HgBlame.aspx?revpathid=" + this.StringAffectedPathId
                                                                                     + "&rev=" + revision
                                                                                     + ">");
