...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GitLog.aspx.cs" Inherits="BugTracker.Web.GitLog" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    <p>
        <form id="frm" target="_blank" action="GitDiff.aspx" method="GET">
