...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="BugTracker.Web.admin" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <form name="pp" id="pp" action="https://www.paypal.com/cgi-bin/webscr" method="post">
        ...
        </span>&nbsp;<span class="smallnote">Change if(false) to if(true) near line 27 in admin.aspx to remove this.</span>
