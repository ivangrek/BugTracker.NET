...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_user.aspx.cs" Inherits="BugTracker.Web.edit_user" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div class="smallnote" style="width: 400px;">
                                            Default <% Response.Write(Util.get_setting("SingularBugLabel", "bug")); %> Query is what you see when you click on the "<% Response.Write(Util.get_setting("PluralBugLabel", "bug")); %>" link
                                        </div>
                                    </td>
                                </tr>
