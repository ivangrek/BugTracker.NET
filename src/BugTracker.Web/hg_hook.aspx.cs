...
namespace BugTracker.Web
{
    ...
    public partial class hg_hook : Page
    {
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (username != Util.get_setting("MercurialHookUsername", ""))
            {
            ...
            Util.write_to_log("hg_log follows");
            Util.write_to_log(hg_log);
...
";
                ...
                var hgrev_id = Convert.ToInt32(DbUtil.execute_scalar(sql));
...
N'$hgap_path'
        ...
        {
            var regex_pattern = Util.get_setting("MercurialBugidRegexPattern", "(^[0-9]+)");
