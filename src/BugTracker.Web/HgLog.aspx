...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HgLog.aspx.cs" Inherits="BugTracker.Web.HgLog" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    <p>
        <form id="frm" target="_blank" action="HgDiff.aspx" method="GET">
