...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Log.aspx.cs" Inherits="BugTracker.Web.Versioning.Hg.Log" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    <p>
        <form id="frm" target="_blank" action="<%= ResolveUrl("~/Versioning/Hg/Diff.aspx") %>" method="GET">
