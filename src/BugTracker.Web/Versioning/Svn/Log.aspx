...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Log.aspx.cs" Inherits="BugTracker.Web.Versioning.Svn.Log" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    <form id="frm" target="_blank" action="<%= ResolveUrl("~/Versioning/Svn/Diff.aspx") %>" method="GET">
    ...
    <p>
        ...
        <td class="datah">
            ...
            <a style="color: red;" id="do_diff_disabled" href="javascript:on_do_diff()">select<br>
                two<br>
                revisions</a></span>
        <% fetch_and_write_history(this.FilePath); %>
        </table>
</asp:Content>
