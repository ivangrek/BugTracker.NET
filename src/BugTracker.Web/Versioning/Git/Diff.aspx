...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Diff.aspx.cs" Inherits="BugTracker.Web.Versioning.Git.Diff" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
        ...
        <tr>
            ...
            <td valign="top">
                <div style="border: 1px solid gray; margin: 3px; padding: 4px;">
                    <div class="difftitle">
                        <% Response.Write(this.LeftTitle); %>
                    </div>
                    <pre id="left" style="overflow-x: auto;">
<% Response.Write(this.LeftOut); %>
              </pre>
                </div>
            ...
            <td valign="top">
                <div style="border: 1px solid gray; margin: 3px; padding: 4px;">
                    <div class="difftitle">
                        <% Response.Write(this.RightTitle); %>
                    </div>
                    <pre id="right" style="overflow-x: auto;">
<% Response.Write(this.RightOut); %>
                </pre>
                </div>
        ...
        <p>
          ...
          <% Response.Write(HttpUtility.HtmlEncode(this.UnifiedDiffText)); %>
        </pre>
</asp:Content>
