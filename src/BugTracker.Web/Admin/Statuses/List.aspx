...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    <div class="main">
        <a href="<%= ResolveUrl("~/Admin/Statuses/Edit.aspx")%>">add new status</a>

        <%
            if (this.Ds.Tables[0].Rows.Count > 0)
            {
                SortableHtmlTable.CreateFromDataSet(Response, this.Ds, ResolveUrl("~/Admin/Statuses/Edit.aspx?id="), ResolveUrl("~/Admin/Statuses/Delete.aspx?id="));
            }
            else
            {
