...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    <div class="main">
        <a href="<%= ResolveUrl("~/Admin/UserDefinedAttributes/Edit.aspx")%>">add new user defined attribute value</a>

        <%
            if (this.Ds.Tables[0].Rows.Count > 0)
            {
                SortableHtmlTable.CreateFromDataSet(Response, this.Ds,
                    ResolveUrl("~/Admin/UserDefinedAttributes/Edit.aspx?id="),
                    ResolveUrl("~/Admin/UserDefinedAttributes/Delete.aspx?id="));
            }
            else
            {
