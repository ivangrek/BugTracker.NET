...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    <div class="main">
        <a href="<%= ResolveUrl("~/Admin/Priorities/Edit.aspx")%>">add new priority</a>

        <%
            if (this.Ds.Tables[0].Rows.Count > 0)
            {
                SortableHtmlTable.CreateFromDataSet(Response, this.Ds,
                    ResolveUrl("~/Admin/Priorities/Edit.aspx?id="),
                    ResolveUrl("~/Admin/Priorities/Delete.aspx?id="), false);
            }
            else
            {
