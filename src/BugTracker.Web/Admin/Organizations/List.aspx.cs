    ...
    public partial class List : Page
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Ds = DbUtil.GetDataSet(
                @"select og_id [id],
        '<a href=" + ResolveUrl("~/Admin/Organizations/Edit.aspx") + @"?id=' + convert(varchar,og_id) + '>edit</a>' [$no_sort_edit],
        '<a href=" + ResolveUrl("~/Admin/Organizations/Delete.aspx") + @"?id=' + convert(varchar,og_id) + '>delete</a>' [$no_sort_delete],
        og_name[desc],
