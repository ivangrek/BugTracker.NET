    ...
    public partial class List : Page
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Ds = DbUtil.GetDataSet(
                @"select
        pj_id [id],
        '<a href=" + ResolveUrl("~/Admin/Projects/Edit.aspx") + @"?&id=' + convert(varchar,pj_id) + '>edit</a>' [$no_sort_edit],
        '<a href=" + ResolveUrl("~/Admin/Projects/EditUserPermissions2.aspx") + @"?projects=y&id=' + convert(varchar,pj_id) + '>permissions</a>' [$no_sort_per user<br>permissions],
        '<a href=" + ResolveUrl("~/Admin/Projects/Delete.aspx") + @"?id=' + convert(varchar,pj_id) + '>delete</a>' [$no_sort_delete],
        pj_name [project],
