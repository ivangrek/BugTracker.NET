...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    <div class="main">
        <table border="0">
            <tr>
                <td>
                    <a href="<%= ResolveUrl("~/Admin/Projects/List.aspx")%>">back to projects</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div id="tab1" style="display: block;">
                            <table border="0" cellpadding="3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="active" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="lbl">Auto-Assign New <% Response.Write(ApplicationSettings.PluralBugLabel); %> to Default User:</td>
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="auto_assign" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
                    ...
                    <br>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="auto_subscribe" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
                    ...
                    <br>
                                ...
                                <tr>
                                    <td class="lbl">Enable Receiving <% Response.Write(ApplicationSettings.PluralBugLabel); %> via POP3 (btnet_service.exe):</td>
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="enable_pop3" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <span class="smallnote">The following is used as the "From" email address when you respond to <% Response.Write(ApplicationSettings.PluralBugLabel); %> generated by emails
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea runat="server" class="txt" id="desc" rows="5" cols="40"></textarea>
                                    </td>
                    ...
                    <br>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="enable_custom_dropdown1" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea cols="40" rows="2" runat="server" type="text" class="txt" id="custom_dropdown_values1"></textarea>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="enable_custom_dropdown2" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea cols="40" rows="2" runat="server" type="text" class="txt" id="custom_dropdown_values2"></textarea>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="enable_custom_dropdown3" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea cols="40" rows="2" runat="server" type="text" class="txt" id="custom_dropdown_values3"></textarea>
                                    </td>
