    ...
    public partial class EditStyles : Page
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Ds = DbUtil.GetDataSet(
                @"select
            '<a target=_blank href=" + ResolveUrl("~/Admin/Priorities/Edit.aspx") + @"?id=' + convert(varchar,pr_id) + '>' + pr_name + '</a>' [priority],
            '<a target=_blank href=" + ResolveUrl("~/Admin/Statuses/Edit.aspx?id=") + @"?id=' + convert(varchar,st_id) + '>' + st_name + '</a>' [status],
