...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    <div class="main">
        <table border="0">
            <tr>
                <td>
                    ...
                    <a href="<%= ResolveUrl("~/Admin/Users/List.aspx")%>">back to users</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div id="tab1" style="display: block;">
                            <table border="0" cellpadding="3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="admin" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="use_fckeditor" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div class="smallnote" style="width: 400px;">
                                            Default <% Response.Write(ApplicationSettings.SingularBugLabel); %> Query is what you see when you click on the "<% Response.Write(ApplicationSettings.PluralBugLabel); %>" link
                                        </div>
                                    </td>
                                </tr>

                                <tr>
                                    <td class="lbl">Default <% Response.Write(ApplicationSettings.SingularBugLabel); %> Query:</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="txt" id="signature" rows="2" cols="50" runat="server"></textarea>
                                    </td>
                        ...
                        <div id="tab2" style="display: none;">
                            <table border="0" cellpadding="3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="enable_notifications" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="auto_subscribe_own" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="auto_subscribe_reported" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
                ...
                <span class="smallnote">Delete old subscriptions and create new ones, according to above settings.</span>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox runat="server" class="cb" ID="send_to_self" />
                                    </td>
                                    <td>&nbsp</td>
                                </tr>
        ...
        <tr>
            <td colspan="2" class="lbl">Force user to add new <% Response.Write(ApplicationSettings.PluralBugLabel); %> to this project:&nbsp;&nbsp;
