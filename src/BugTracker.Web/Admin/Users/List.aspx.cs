...
namespace BugTracker.Web.Administration.Users
{
    ...
    public partial class List : Page
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            select u.us_id [id],
            '<a href=" + ResolveUrl("~/Admin/Users/Edit.aspx") + @"?id=' + convert(varchar,u.us_id) + '>edit</a>' [$no_sort_edit],
            '<a href=" + ResolveUrl("~/Admin/Users/Edit.aspx") + @"?copy=y&id=' + convert(varchar,u.us_id) + '>copy</a>' [$no_sort_add<br>like<br>this],
            '<a href=" + ResolveUrl("~/Admin/Users/Delete.aspx") + @"?id=' + convert(varchar,u.us_id) + '>delete</a>' [$no_sort_delete],

            u.us_username [username],
            isnull(u.us_firstname,'') + ' ' + isnull(u.us_lastname,'') [name],
            '<a sort=''' + og_name + ''' href=" + ResolveUrl("~/Admin/Organizations/Edit.aspx") + @"?id=' + convert(varchar,og_id) + '>' + og_name + '</a>' [org],
