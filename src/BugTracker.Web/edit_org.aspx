...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_org.aspx.cs" Inherits="BugTracker.Web.edit_org" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    <div class="align">
                    ...
                    <form class="frm" runat="server">
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input runat="server" type="text" class="txt" id="og_name" maxlength="30" size="30">
                                </td>
        ...
        <table border="0">
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="external_user" />
                </td>
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="can_only_see_own_reported" />
                </td>
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="can_be_assigned_to" />
                </td>
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="non_admins_can_use" />
                </td>
    ...
    <td colspan="2">
        ...
        <%
            foreach (DataRow dr_custom in this.ds_custom.Tables[0].Rows)
            {
                ...
                var radio = this.radio_template;
                var selected_val = this.dict_custom_field_permission_level[bg_name];
        ...
        <table border="0">
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="can_edit_sql" />
                </td>
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="can_delete_bug" />
                </td>
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="can_edit_and_delete_posts" />
                </td>
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="can_merge_bugs" />
                </td>
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="can_mass_edit_bugs" />
                </td>
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="can_use_reports" />
                </td>
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="can_edit_reports" />
                </td>
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="can_view_tasks" />
                </td>
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="can_edit_tasks" />
                </td>
            ...
            <tr>
                <td>
                    <asp:CheckBox runat="server" class="cb" ID="can_assign_to_internal_users" />
                </td>
