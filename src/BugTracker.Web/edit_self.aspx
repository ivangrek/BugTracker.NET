...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_self.aspx.cs" Inherits="BugTracker.Web.edit_self" MasterPageFile="~/Site.Master" ClientIDMode="Static" %>
...
<asp:Content ContentPlaceHolderID="BodyHeader" runat="server">
    <% this.security.write_menu(Response, "settings"); %>
</asp:Content>
                        ...
                        <div id="tab1" style="display: block;">
                            ...
                            <table border="0" cellpadding="3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="txt" id="signature" rows="2" cols="72" runat="server"></textarea>
                                    </td>
